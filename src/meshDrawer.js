...
void main()
{
	...
	// Diffuse lighting hesaplama
	diff = max(dot(normal, lightdir), 0.0);

	// Specular lighting hesaplama
	vec3 viewDir = normalize(-vPosition); // Camera'nın pozisyonuna göre yön
	vec3 reflectDir = reflect(-lightdir, normal); // Işığın yansıma yönü
